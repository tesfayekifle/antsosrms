...
<body>
    ...
    <div class="title">
    <a href="dashboard.php"><img src="images/Antsokiya Logo.jpg" alt="" class="logo"></a>
    ...
    <div class="nav">
        <ul>
            <li class="dropdown" onclick="toggleDisplay('1')">
                <a href="" class="dropbtn">Grades &nbsp
                    <span class="fa fa-angle-down"></span>
                </a>
                <div class="dropdown-content" id="1">
                    <a href="add_classes.php">Add Grades</a>
                    <a href="manage_classes.php">Manage Grades</a>
                </div>
            </li>
    ...
    <div class="footer">
        <!-- <span>Designed & Coded By Tesfaye Kifle </span> -->
    </div>
</body>
</html>
